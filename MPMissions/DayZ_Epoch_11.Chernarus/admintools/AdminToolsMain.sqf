...
if ((getPlayerUID player) in [AdminUID1,AdminUID2,AdminUID3]) then { //all admins
	if ((getPlayerUID player) in [AdminUID1,AdminUID2,AdminUID3]) then { //mods
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in [AdminUID1,AdminUID2,AdminUID3]) then { //admins
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in [AdminUID1,AdminUID2,AdminUID3]) then { // super admins
		adminmenu =
		[
			["",true],
